...
<script>
	...
	$("#division_form").data('bootstrapValidator').resetForm();
	}
</script>
...
$("#division").on('click','#divisionEditing',function() {
	...
	$.ajax({
	    ...
	    type: "GET",
	    contentType : "application/json",
	    url: "/HRMS/getdivisions?divisionid=" + divisionid, //this is my servlet
	    success: function(data){ 
...
function saveDivision(){
	...
	saveDivision["estddate"] = $("#saveEstddate").val(); 
  ...
  <div class="modal fade" id="newDivision" role="dialog">
	...
	<div class="modal-dialog modal-lg">
  	...
  	<strong id="DivisionSaveStrong" ></strong> 
       ...
       <form id="division_form" autocomplete="on|off">
