...
function scan() {
	$.ajax({
        type: "get",
        url: "getscan", //this is my servlet
...
<button  onclick="scan()"><h3 align="center">Scan</h3></button>
<!DOCTYPE html>
<html>
    <head>
...
<script type="text/javascript" src="resources/customjs/qrcodelib.js"></script>
 <script type="text/javascript" src="resources/customjs/webcodecamjs.js"></script>
<script type="text/javascript" src="resources/customjs/main.js"></script>
<!-- <script type="text/javascript" src="resources/customjs/DecoderWorker.js"></script> -->
<!-- <script type="text/javascript" src="resources/customjs/filereader.js"></script> -->
<!-- <script type="text/javascript" src="resources/customjs/mainjquery.js"></script> -->
<!-- <script type="text/javascript" src="resources/customjs/webcodecamjquery.js"></script> -->
</html>
</body>
</html>