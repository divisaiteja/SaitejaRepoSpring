...
<script>
				$(document).ready(function() {					
						$("#fileUpload").on('change',function() {
											...
											//var size=$(this)[0].files.size;
											//alert(this.files[0].size);
											var imagesize=this.files[0].size;
											var kbconverter=imagesize/1024;
											if(kbconverter>40){
												alert("image not more than 40 mb");
												$("#fileUpload").val('');
												window.location.reload();
											}
											alert(countFiles.size());
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-3" align="right">
			<div id="myimage" width="107" height="98"></div>
...
<div>
	...
	<div class="box-content row">
		...
		<div class="col-md-6">
			<input type="image" id="image" alt="Login" align="right"onclick="disableTextBox()"src="resources/assets/images/edit-icon.png" height="15" width="15">
						
		</div>
	</div>
				<h4 id="jobdetailsUpdateDisplayMessage" style="color:green" align="center"></h4>
	<!-- <hr color="00FFFF"> -->
</div>
	...
	<div class="box-content row">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">ID No</label> <input
				type="text" name="idNumber" id="idNumber" value="${idNumber}" class="form-control"
				readonly="readonly">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1"> Date Of
				Joining</label> <input type="text" name="doj" id="doj" class="form-control">
		...
		<div class="form-group has-warning    col-md-3">
			...
			<label> <input type="checkbox" id="isTechnical" value="1">Yes
			</label><br>
		</div>
...
<div class="col-md-12">
			<input type="image" id="" alt="Login" align="right"
				onclick="disableTextBox4()" src="resources/assets/images/edit-icon.png" height="15" width="15">
		</div>
	...
	<div class="box-content row">
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">ParentID</label> <input
				type="text" id="shifschIdNumber" value="${idNumber}" class="form-control" readonly="readonly">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">EffectFrom</label> 
			<input type="text" id="effectFrom" class="form-control">
		...
		<div class="form-group has-warning col-md-3">
			...
			<select class="form-control" id="otEligibility">
...
<h3  id="personalDetailsDisplayMessage" align="center" style="color: green"></h3>
<div>
...
<form id="personal_form">
	<div class="box-content row">
		...
		<div class="form-group has-warning    col-md-3">
			<label class="control-label" for="inputWarning1">Maritial
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Date of
				Birth</label> 
				<input type="text" name="doBirth" id="doBirth" class="form-control">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Passport
				...
				id="passportvalidity" class="form-control">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Pancard No</label> <input
				type="text" name="pancard" id="pancardnumber" class="form-control">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">BankBranch</label> <input
				type="text" name="bankbranch" id="bankbranch" class="form-control">

		</div>
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Account No</label> <input
				type="text" name="accountnumber" id="accountnumber"
				class="form-control">

		</div>
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">BankIFSCCode</label>
	...
	<div align="right">
		<input type="button" value="update" id="personal_update" class="btn btn-success"> 
	</div>
</form>
<hr color="00FFFF">
...
<div>
	<h5 align="center">
		To Add Experience Details <a data-toggle="modal"
			data-target="#myModal" id="experienceid" href="#">ClickHere</a>
	</H5>
</div>
<div>
...
<div>
	<h3 align="left" style="color: #fb8c00">Salary Details</h3>
	<input align="right" type="image" id="image" alt="Login"
...
<form id="salary_form">
	<div class="box-content row">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Conveyance</label> <input
				type="text" id="conveyance" name="conveyance" class="form-control">
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Others1</label> <input
				type="text" name="others1" id="others1" class="form-control">

		</div>

		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Others2</label> <input
				type="text" name="others2" id="others2" class="form-control">

		</div>
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">Gross Salary</label>
		...
		<div class="form-group has-warning col-md-3">
			<label class="control-label" for="inputWarning1">ESI Number</label> <input
				type="text" name="esinumber" id="esinumber" class="form-control">
	...
	<div align="right">
		<input type="submit" value="update" id="salary_submit" class="btn btn-success"> 
...
<div>
	...
	<input align="right" type="image" id="image" alt="Login"
		onclick="disableTextBox()" src="resources/assets/images/edit-icon.png"
		height="25" width="25">
</div>
<br>
...
<div class="box-content row">
	...
	<div class="form-group has-warning col-md-3">
		<label class="control-label" for="inputWarning1">Current
			Experience</label> <input type="text" name="" id="currentexperience"
			value="" class="form-control">
...
<div>
	...
	<form id="doc_form">
		<div class="row">
			...
			<div class="form-group has-warning col-sm-5">
				<label class="control-label" for="inputWarning1">Document
					Name:</label> <input type="file" id="doc" name="doc" class="form-control">
			</div>
...
<div>
	...
	<div id="wrapper" style="margin-top: 20px;">
		...
		<input type="submit" id="photo_submit" class="btn btn-primay" >
	</div>
	</form>
</div>
<!--  Others Details  end  -->
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" onClick="resetExperience()">&times;</button>
			
			</div>
			<h3 id="ExperiencedetailsDisplayMessage" align="center" style="color:green"></h3>
			<form id="exp_form">
				<div class="modal-body">
					<div class="box-content row">
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">ParentId</label>
							<input type="text" id="Expid" value="${idNumber}"  class="form-control" >
						</div>
						<div class="form-group has-warning col-md-3">
						...
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">Experience
								Details</label> <input type="text" id="experiencedetails"
						...
						<div class="form-group has-warning col-md-3">
						 ...
						 <div class="form-group has-warning col-md-3">
						<label class="control-label" for="inputWarning1">Exptranid</label> <input
							type="text" id="Exptranid" name="Exptranid" class="form-control" readonly="readonly">
					</div> 
					</div>
...
<div class="modal fade" id="myModal1" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<h3 id="EducationDetailsDisplayMessage" align="center" style="color:green"></h3>
			<form id="edu_form">
				<div class="modal-body">
					<div class="box-content row">
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">ParentId</label>
							<input type="text" id="Epid" value="${idNumber}"  name="Epid" class="form-control">
						</div>

						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">Certificate</label>
							<input type="text" id="certificates" name="certificates"
								class="form-control">
						</div>
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">InstituteName</label>
						...
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">YearOfPassing</label>
							<input type="text" id="yearofpassing" name="yearofpassing"
								class="form-control">
						</div>
						...
						<div class="form-group has-warning col-md-3">
							...
							<input type="text" id="Edutranid" name="Edutranid" readonly="readonly"
								class="form-control">
						</div>
...
<div class="modal fade" id="myModal2" role="dialog">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" onClick="resetFamilyForm()">&times;</button>
			</div>
			<h3 id="FamilyDetailsDisplayMessage" align="center" style="color:green"></h3>
			<form id="familyValidation">
				<div class="modal-body">
					<div class="box-content row">
						...
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">Gender</label> 
							<input type="text" id="familyidnumber" value="${idNumber}"  class="form-control" hidden="hidden">
							<!-- <input
						...
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">DateOfBirth</label>
							<input type="text" id="dob" name="dob" class="form-control">
						</div>
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">AdhaarNo</label>
						...
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">MobileNO</label>
							<input type="text" id="mobileno" name="mobileno"
								class="form-control">
						</div>
						<div class="form-group has-warning col-md-3">
							<label class="control-label" for="inputWarning1">familytranid</label>
							<input type="text" id="familytranid" name="familytranid" readonly="readonly"
								class="form-control"  >
						</div>
					</div>
				</div>
...
<!--       <script src="http://code.jquery.com/jquery-1.10.2.js"></script>   -->
   ...
   <body>  
	...
	<script>
		...
		$("#shiftshedulesubmit").on("click", function() {

			$('#employeeshiftschedule_form').data('bootstrapValidator').validate();

			if ($('#employeeshiftschedule_form').data('bootstrapValidator').isValid()) {
				editEmployeeShifts();
			}
