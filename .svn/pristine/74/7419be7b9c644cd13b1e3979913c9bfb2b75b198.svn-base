...
$(document).ready(function() {
	var table=$('#myTab').dataTable({
		    ...
		    searching: true,
			 "ajax" : {
			"url" : "/DASHBOARD/AttendenceModify?date="+date+"&idno="+idno,
			"dataSrc" : "dataBean",
			"type" : "GET",
...
System.out.println(date+id);
			   ...
			   // SQLQuery querys = sessions.createSQLQuery("select * from hr_punches where idno="+id+" and  attdate='"+date+"' order by punchtime asc");
			%>
