...
$(document).ready(function() {
	$.ajax({
        ...
        url: "/DASHBOARD/getDropdowns", //this is my servlet
...
$(document).ready(function() {
	$.ajax({
        type: "GET",
        contentType : "application/json",
        url: "/DASHBOARD/getDropdownsForI", //this is my servlet
          success: function(data){ 
          	var abc=data;
...
function getDataFromAnother(abc){
 ...
 var date=document.getElementById("date").value;
 	...
 	$.ajax({
        type: "GET",
        contentType : "application/json",
        url: "/DASHBOARD/displayHrPunches?idno="+idno+"&date="+date, //this is my servlet
          success: function(data){ 
	     	var json=data;
        	 var tr;
	 ...
	 if(punchtypes!=""){
		 $.ajax({
	 	       ...
	 	       // url: "AddHrPunchCodesForI.jsp?idno="+idno+"&punchtypes="+punchtypes+"&date="+date,
	 	        url: "AddHrPunchCodesForI?idno="+idno+"&punchtypes="+punchtypes+"&date="+date+"&shiftcode=0",
