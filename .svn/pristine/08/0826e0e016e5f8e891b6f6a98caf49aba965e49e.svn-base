...
public class SalaryDeductionsController {
	...
	public BaseResponseDTO getAllSalaryDeductions(@RequestParam("division") int division,
		...
		List<SalaryDeductionsDTO> allSalaryDeductionsDetails = salaryDeductionsService
				.getAllSalaryDeductionsDetails(division, tmonth, tyear);
	...
	public BaseResponseDTO editSalaryDeductions(@RequestBody SalaryDeductionsDTO salaryDeductionsDTO) {
		salaryDeductionsService.editSalaryDeductions(salaryDeductionsDTO);
		BaseResponseDTO response = new BaseResponseDTO();
	...
	@ResponseBody
	public List<SalaryDeductionsDTO> getSalaryDeductionInformationByIdno(@RequestParam(value = "idno") int idno,
			ModelMap map) {


		List<SalaryDeductionsDTO> salaryDeductionsDetailsInfoByIdno = salaryDeductionsService
				.getSalaryDeductionsDetailsInfoByIdno(idno);
	...
	@ResponseBody
	public BaseResponseDTO getStandardDeductionInformation(@RequestParam(value="standardDeductionFieldId") int standardDeductionFieldId,@RequestParam(value="divisionid") int divisionid) {
		List<StandardPayDetectionsDTO> standardPayDetectionsDTOList = salaryDeductionsService
				.getStandardDeductionInformation(standardDeductionFieldId,divisionid);
		BaseResponseDTO response = new BaseResponseDTO();
	...
	@ResponseBody
	public List<StandardPayDetectionsDTO> 	getStandardDeductionInformationByIdno(@RequestParam(value = "idno") int idno,
			ModelMap map) {
        List<StandardPayDetectionsDTO> standardDeductionsDetailsInfoByIdno = salaryDeductionsService.getStandardDeductionsDetailsInfoByIdno(idno);
        BaseResponseDTO response = new BaseResponseDTO();
	...
	public BaseResponseDTO editStandardDeductions(@RequestBody StandardPayDetectionsDTO standardPayDetectionsDTO) {
		salaryDeductionsService.editStandardDeductions(standardPayDetectionsDTO);
        BaseResponseDTO response = new BaseResponseDTO();
		response.setSuccessMessage("EditedSucessfully");
		return response ;
