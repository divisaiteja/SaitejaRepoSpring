...
public class OthersDetailsDaoImpl implements OthersDetailsDao {
	...
	public void saveOthersDetails(OthersDetailsDTO othersDetailsDTO) {
		String sql="insert into hr_otherdetails(languagesknown,qualification,previousexperience,currentexperience,tranid,idno) values('"+othersDetailsDTO.getLanguagesknown()+"','"+othersDetailsDTO.getQualification()+"','"+othersDetailsDTO.getPreviousexperience()+"','"+othersDetailsDTO.getPreviousexperience()+"',"+othersDetailsDTO.getTranid()+"',"+othersDetailsDTO.getIdno()+")";
