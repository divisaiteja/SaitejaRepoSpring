...
public class PersonalDetailsDTO {
	...
	public int getPersonalparentid() {
		return personalparentid;
	}

	public void setPersonalparentid(int personalparentid) {
		this.personalparentid = personalparentid;
	}
	...
	public void setDrivinglicencevalidity(String drivinglicencevalidity) {
